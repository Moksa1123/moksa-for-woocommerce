...
<p><strong><?php esc_html_e( '您的包裹已送達取件門市，請於 7 天內持證件至門市取貨。', 'mo-ectools' ); ?></strong></p>
...
<table cellspacing="0" cellpadding="6" border="1" style="width:100%;border-collapse:collapse;margin-bottom:16px;">
	<?php if ( $mo_store_name ) : ?>
		<tr><th align="left"><?php esc_html_e( '取件門市', 'mo-ectools' ); ?></th><td><?php echo esc_html( $mo_store_name ); ?></td></tr>
	<?php endif; ?>
	<?php if ( $mo_store_id ) : ?>
		<tr><th align="left"><?php esc_html_e( '門市代號', 'mo-ectools' ); ?></th><td><?php echo esc_html( $mo_store_id ); ?></td></tr>
	<?php endif; ?>
	<?php if ( $mo_store_address ) : ?>
		<tr><th align="left"><?php esc_html_e( '門市地址', 'mo-ectools' ); ?></th><td><?php echo esc_html( $mo_store_address ); ?></td></tr>
	<?php endif; ?>
</table>
<?php endif; ?>

<p><?php esc_html_e( '逾期未取件，包裹將退回物流中心，並可能產生退運費用。', 'mo-ectools' ); ?></p>
