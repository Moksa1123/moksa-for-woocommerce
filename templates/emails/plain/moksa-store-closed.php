...
echo sprintf(
	...
	esc_html__( '您原先選擇的取件門市「%s」目前暫停服務（門市裝修／搬遷／改店號），請儘速重新選擇可配達的取件門市。', 'moksa-for-woocommerce' ),
	esc_html( $mo_store_name ?: __( '未知門市', 'moksa-for-woocommerce' ) )
) . "\n\n";
echo esc_html__( '逾期未重選，包裹將退回物流中心。請至「我的帳戶 > 訂單」進入此訂單頁面點擊重選門市，或聯絡客服協助。', 'moksa-for-woocommerce' ) . "\n\n";
