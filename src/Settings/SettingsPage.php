...
final class SettingsPage extends \WC_Settings_Page {
	...
	private function advanced_fields(): array {
		return [
			...
			[
				'title'    => __( 'Follow-up status check', 'moksa-for-woocommerce' ),
				'id'       => 'moksafowo_shipping_reconcile_enabled',
				'type'     => 'checkbox',
				'default'  => 'yes',
				'desc'     => __( 'Check with the carrier once an hour for orders whose status has not moved, and apply whatever the carrier reports.', 'moksa-for-woocommerce' ),
				'desc_tip' => __( 'Carriers push status updates to this site, but a push can be lost — the order then sits on an old status for good. This looks those orders up instead of waiting. ECPay and PAYUNi are covered.', 'moksa-for-woocommerce' ),
			],
			[
				'title'             => __( 'Wait before checking', 'moksa-for-woocommerce' ),
				'id'                => 'moksafowo_shipping_reconcile_min_hours',
				'type'              => 'number',
				'default'           => '6',
				'custom_attributes' => [
					'min'  => '1',
				...
				'desc'              => __( 'hours since the order last changed', 'moksa-for-woocommerce' ),
				'desc_tip'          => __( 'Give the carrier time to push the update itself first. Too short and the site keeps asking for news that is already on its way.', 'moksa-for-woocommerce' ),
			],
			[
				'type' => 'sectionend',
				'id'   => 'moksafowo_shipping_common_section',
			...
			[
				...
				'id'            => 'moksafowo_shipping_status_moksa_shipped_enabled',
				'type'          => 'checkbox',
				'default'       => 'yes',
			...
			[
				'id'            => 'moksafowo_shipping_status_moksa_cvs_arrived_enabled',
				'type'          => 'checkbox',
				'default'       => 'yes',
			...
			[
				'id'            => 'moksafowo_shipping_status_moksa_store_closed_enabled',
				'type'          => 'checkbox',
				'default'       => 'yes',
			...
			[
				'id'            => 'moksafowo_shipping_status_moksa_unclaimed_enabled',
				'type'          => 'checkbox',
				'default'       => 'yes',
				'desc'          => __( 'Not collected (the customer never picked the parcel up and it is on its way back)', 'moksa-for-woocommerce' ),
				'checkboxgroup' => 'end',
			],
			[
				'type' => 'sectionend',
