		...
		<div class="moksafowo-card<?php echo $enabled ? ' is-on' : ''; ?>">
			...
			<div class="moksafowo-card__action">
				<?php if ( $enabled && $settings_url !== '' ) : ?>
					<a class="moksafowo-link" href="<?php echo esc_url( $settings_url ); ?>"><?php esc_html_e( 'Settings →', 'moksa-for-woocommerce' ); ?></a>
				<?php endif; ?>
				<?php if ( $toggle_name !== '' ) : ?>
	...
	public static function subsection_banner( string $name, bool $enabled, string $back_url ): void {
		...
		<div class="moksafowo-subsection-banner">
			<div class="moksafowo-subsection-banner__head">
				...
				<?php if ( $enabled ) : ?>
					<span class="moksafowo-subsection-banner__status is-on">✓ <?php esc_html_e( 'Enabled', 'moksa-for-woocommerce' ); ?></span>
				<?php else : ?>
					<span class="moksafowo-subsection-banner__status is-off">✗ <?php esc_html_e( 'Disabled', 'moksa-for-woocommerce' ); ?></span>
				<?php endif; ?>
			</div>
		</div>
		<?php
