	...
	public function get_settings(): array {
		return [
			[
				...
				'id'    => 'mo_ecpay_invoice_section',
			],
			[
				'title'   => __( '啟用測試模式', 'mo-ectools' ),
				'id'      => 'mo_ecpay_invoice_sandbox_enabled',
				'type'    => 'checkbox',
				'default' => 'yes',
			...
			[
				...
				'type'  => 'title',
				'id'    => 'mo_ecpay_invoice_behavior_section',
			],
			[
				'title'             => __( '發票編號前綴', 'mo-ectools' ),
				'id'                => 'mo_ecpay_invoice_prefix',
				'type'              => 'text',
				'default'           => '',
			...
			[
				...
				'id'      => 'mo_ecpay_invoice_issue_when',
				'type'    => 'select',
				'options' => [
			...
			[
				...
				'id'                => 'mo_ecpay_invoice_delay_days',
				'type'              => 'number',
				'default'           => 0,
			...
			[
				...
				'id'      => 'mo_ecpay_invoice_auto_cancel',
				'type'    => 'select',
				'default' => 'manual',
				'options' => [
			...
			[
				...
				'id'      => 'mo_ecpay_invoice_carrier_api_check',
				'type'    => 'checkbox',
				'default' => 'yes',
			...
			[
				...
				'id'      => 'mo_ecpay_invoice_allow_donate',
				'type'    => 'checkbox',
				'default' => 'yes',
				'desc'    => __( '提供「捐贈發票」選項（消費者輸入 3-7 碼捐贈碼）。', 'mo-ectools' ),
			],
			[
				'title'             => __( '預設捐贈碼', 'mo-ectools' ),
				'id'                => 'mo_ecpay_invoice_default_donate_code',
				'type'              => 'text',
				'default'           => '',
				'desc_tip'          => __( '留空 = 顧客自己輸入（一般情況）。填了 = 顧客選捐贈時自動帶入這個碼（適合長期合作公益單位的店家）。', 'mo-ectools' ),
				'custom_attributes' => [ 'pattern' => '[0-9]{0,7}', 'maxlength' => 7 ],
			],
			[
				'title'   => __( '結帳允許統編（公司用三聯式）', 'mo-ectools' ),
				'id'      => 'mo_ecpay_invoice_allow_b2b',
				'type'    => 'checkbox',
				'default' => 'yes',
			...
			[
				...
				'id'      => 'mo_ecpay_invoice_default_carrier',
				'type'    => 'select',
				'options' => [
			...
			[
				...
				'type'  => 'title',
				'id'    => 'mo_ecpay_invoice_debug_section',
			],
			[
				'title'   => __( 'Debug 日誌', 'mo-ectools' ),
				'id'      => 'mo_ecpay_invoice_debug_log_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
