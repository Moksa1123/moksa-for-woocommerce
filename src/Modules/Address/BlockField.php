...
final class BlockField {
	...
	public static function validate_district_for_home( $data, $errors ): void {
		...
		if ( '' === $district ) {
			$errors->add( 'moksafowo_district_required', __( 'Please select a district for home delivery orders.', 'moksa-for-woocommerce' ) );
		}
	}
	...
	public static function enforce_district_block( \WC_Order $order, $request ): void {
		...
		if ( '' === $order->get_shipping_city() && '' === $order->get_billing_city() ) {
			throw new \Automattic\WooCommerce\StoreApi\Exceptions\RouteException(
				...
				esc_html__( 'Please select a district for home delivery orders.', 'moksa-for-woocommerce' ),
				400
			);
		}
	}
	...
	public static function register_field(): void {
		...
		woocommerce_register_additional_checkout_field(
			[
				'id'          => self::FIELD_ID,
				'label'       => __( 'District', 'moksa-for-woocommerce' ),
				'location'    => 'address',
				'type'        => 'select',
