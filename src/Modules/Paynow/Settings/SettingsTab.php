...
namespace MoksaWeb\Mowc\Modules\Paynow\Settings;
	...
	public function get_settings(): array {
		return [
			[
				...
				'id'    => 'mo_paynow_section',
			],
			[
				'title'   => __( '啟用測試模式', 'mo-ectools' ),
				'id'      => 'mo_paynow_sandbox_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
			...
			[
				...
				'type'  => 'title',
				'id'    => 'mo_paynow_misc_section',
			],
			[
				'title'    => __( 'EC 平台名稱（ECPlatform）', 'mo-ectools' ),
				'id'       => 'mo_paynow_ec_platform',
				'type'     => 'text',
				'default'  => '',
			...
			[
				...
				'id'                => 'mo_paynow_atm_deadline_days',
				'type'              => 'number',
				'default'           => 0,
			...
			[
				...
				'id'                => 'mo_paynow_cvs_deadline_days',
				'type'              => 'number',
				'default'           => 0,
			...
			[
				...
				'id'                => 'mo_paynow_code_deadline_days',
				'type'              => 'number',
				'default'           => 0,
			...
			[
				...
				'id'      => 'mo_paynow_debug_log_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
			...
			[
				...
				'id'    => 'mo_paynow_methods_section',
			],
			[
				'title'   => __( '付款方式', 'mo-ectools' ),
				'id'      => 'mo_paynow_enabled_methods',
				'type'    => 'multiselect',
				'class'   => 'wc-enhanced-select',
				'css'     => 'width: 400px;',
				'options' => [
					'mo_paynow_credit'             => __( '信用卡', 'mo-ectools' ),
					'mo_paynow_credit_installment' => __( '信用卡分期', 'mo-ectools' ),
					'mo_paynow_webatm'             => __( 'WebATM', 'mo-ectools' ),
					'mo_paynow_atm'                => __( 'ATM 虛擬帳號', 'mo-ectools' ),
					'mo_paynow_cvs'                => __( '超商條碼繳費', 'mo-ectools' ),
					'mo_paynow_ibon'               => __( 'ibon 代碼繳費', 'mo-ectools' ),
					'mo_paynow_famiport'           => __( 'FamiPort 代碼繳費', 'mo-ectools' ),
					'mo_paynow_icash'              => __( 'iCash 錢包', 'mo-ectools' ),
					'mo_paynow_unionpay'           => __( '銀聯卡', 'mo-ectools' ),
				],
