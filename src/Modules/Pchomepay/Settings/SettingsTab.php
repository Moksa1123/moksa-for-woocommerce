	...
	public function get_settings(): array {
		return [
			[
				...
				'id'    => 'mo_pchomepay_section',
			],
			[
				'title'   => __( '啟用測試模式', 'mo-ectools' ),
				'id'      => 'mo_pchomepay_sandbox_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
			...
			[
				...
				'id'    => 'mo_pchomepay_sandbox_app_id',
				'type'  => 'text',
			],
			[
				'title' => __( '測試 Secret', 'mo-ectools' ),
				'id'    => 'mo_pchomepay_sandbox_secret',
				'type'  => 'text',
			],
			[
				'title' => __( '正式 APP ID', 'mo-ectools' ),
				'id'    => 'mo_pchomepay_app_id',
				'type'  => 'text',
			],
			[
				'title' => __( '正式 Secret', 'mo-ectools' ),
				'id'    => 'mo_pchomepay_secret',
				'type'  => 'text',
			],
			[
				'type' => 'sectionend',
			...
			[
				...
				'type'  => 'title',
				'id'    => 'mo_pchomepay_misc_section',
			],
			[
				'title'    => __( '信用卡分期期數', 'mo-ectools' ),
				'id'       => 'mo_pchomepay_card_installment',
				'type'     => 'text',
				'default'  => '',
			...
			[
				...
				'id'                => 'mo_pchomepay_atm_expire_days',
				'type'              => 'number',
				'default'           => 5,
			...
			[
				...
				'id'                => 'mo_pchomepay_bcode_expire_days',
				'type'              => 'number',
				'default'           => 7,
			...
			[
				...
				'id'      => 'mo_pchomepay_debug_log_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
			...
			[
				...
				'id'    => 'mo_pchomepay_methods_section',
			],
			[
				'title'   => __( '付款方式', 'mo-ectools' ),
				'id'      => 'mo_pchomepay_enabled_methods',
				'type'    => 'multiselect',
				'class'   => 'wc-enhanced-select',
				'css'     => 'width: 400px;',
				'options' => [
					'mo_pchomepay_card'      => __( '信用卡（含分期）', 'mo-ectools' ),
					'mo_pchomepay_pi'        => __( '拍錢包', 'mo-ectools' ),
					'mo_pchomepay_atm'       => __( 'ATM 虛擬帳號', 'mo-ectools' ),
					'mo_pchomepay_barcode'   => __( '超商代碼繳費', 'mo-ectools' ),
					'mo_pchomepay_cvs711'    => __( '7-11 超商取貨付款', 'mo-ectools' ),
					'mo_pchomepay_cvsfamily' => __( '全家超商取貨付款', 'mo-ectools' ),
					'mo_pchomepay_cvshilife' => __( '萊爾富超商取貨付款', 'mo-ectools' ),
				],
