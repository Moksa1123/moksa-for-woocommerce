	...
	public function get_settings(): array {
		return [
			[
				...
				'type'  => 'title',
				'desc'  => __( '向支付連申請取得 APP ID / Secret。支付連沒有公開測試帳號，測試憑證需另行申請。', 'moksa-for-woocommerce' ),
			...
			[
				...
				'type'    => 'checkbox',
				'default' => 'no',
				'desc'    => __( '勾選後所有交易走測試環境不會真扣款。上線後請取消勾選。', 'moksa-for-woocommerce' ),
			],
			[
			...
			[
				'title' => __( '測試 Secret', 'moksa-for-woocommerce' ),
			...
			[
				'title' => __( '正式 Secret', 'moksa-for-woocommerce' ),
			...
			[
				...
				'type'     => 'text',
				'default'  => '',
				'desc_tip' => __( '逗號分隔（例 1,3,6,12,18,24）。留空 = 不啟用分期，僅一次付清。', 'moksa-for-woocommerce' ),
			],
			[
				...
				'type'              => 'number',
				'default'           => 5,
				'desc_tip'          => __( '顧客取得虛擬帳號後幾天內須完成付款（支付連限制 1-5 天）。', 'moksa-for-woocommerce' ),
				'custom_attributes' => [
					'min'  => 1,
					'max'  => 5,
					'step' => 1,
			...
			[
				...
				'type'              => 'number',
				'default'           => 7,
				'desc_tip'          => __( '顧客取得繳費代碼後幾天內須完成付款（支付連限制 1-7 天）。', 'moksa-for-woocommerce' ),
				'custom_attributes' => [
					'min'  => 1,
					'max'  => 7,
					'step' => 1,
			...
			[
				...
				'type'  => 'title',
				'desc'  => __( '勾選要在結帳頁顯示的支付連付款方式。', 'moksa-for-woocommerce' ),
			...
			[
				...
				'css'     => 'width: 400px;',
				'options' => [
					'moksafowo_pchomepay_card'      => __( '信用卡（含分期）', 'moksa-for-woocommerce' ),
					'moksafowo_pchomepay_pi'        => __( '拍錢包', 'moksa-for-woocommerce' ),
					'moksafowo_pchomepay_atm'       => __( 'ATM 虛擬帳號', 'moksa-for-woocommerce' ),
					'moksafowo_pchomepay_barcode'   => __( '超商代碼繳費', 'moksa-for-woocommerce' ),
					'moksafowo_pchomepay_cvs711'    => __( '7-11 超商取貨付款', 'moksa-for-woocommerce' ),
					'moksafowo_pchomepay_cvsfamily' => __( '全家超商取貨付款', 'moksa-for-woocommerce' ),
					'moksafowo_pchomepay_cvshilife' => __( '萊爾富超商取貨付款', 'moksa-for-woocommerce' ),
				],
