...
final class CvsHilife extends AbstractPchomepayGateway {
	...
	protected function build_method_title(): string {
		return __( 'PChomePay Hi-Life pickup and pay', 'moksa-for-woocommerce' );
	}

	protected function build_method_description(): string {
		return __( 'The customer picks a Hi-Life store on the PChomePay page, then pays when collecting.', 'moksa-for-woocommerce' );
	}
}
