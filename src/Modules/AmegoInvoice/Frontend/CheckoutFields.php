...
final class CheckoutFields {
	...
	public static function init(): void {
		...
		if ( 'yes' === get_option( 'moksafowo_paynow_invoice_enabled', 'no' ) ) {
			return;
		}
	...
	public static function render_classic(): void {
		$prefix        = 'moksafowo_amego_invoice';
		...
		echo '<div class="moksafowo-amego-invoice-fields"><h3>' . esc_html__( '電子發票', 'mo-ectools' ) . '</h3>';
