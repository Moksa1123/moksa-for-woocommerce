	...
	public function get_settings(): array {
		return [
			[
				...
				'id'    => 'mo_newebpay_shipping_section',
			],
			[
				'title'   => __( '啟用測試模式', 'mo-ectools' ),
				'id'      => 'mo_newebpay_shipping_sandbox_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
			...
			[
				...
				'id'       => 'mo_newebpay_shipping_lgs_type',
				'type'     => 'select',
				'default'  => 'B2C',
				'options'  => [
			...
			[
				...
				'id'    => 'mo_newebpay_shipping_sandbox_section',
			],
			[
				'title' => __( '測試 MerchantID', 'mo-ectools' ),
				'id'    => 'mo_newebpay_shipping_sandbox_merchant_id',
				'type'  => 'text',
			],
			[
				'title' => __( '測試 HashKey', 'mo-ectools' ),
				'id'    => 'mo_newebpay_shipping_sandbox_hash_key',
				'type'  => 'text',
			],
			[
				'title' => __( '測試 HashIV', 'mo-ectools' ),
				'id'    => 'mo_newebpay_shipping_sandbox_hash_iv',
				'type'  => 'text',
			],
			[
				'type' => 'sectionend',
			...
			[
				...
				'id'    => 'mo_newebpay_shipping_prod_section',
			],
			[
				'title' => __( '正式 MerchantID', 'mo-ectools' ),
				'id'    => 'mo_newebpay_shipping_merchant_id',
				'type'  => 'text',
			],
			[
				'title' => __( '正式 HashKey', 'mo-ectools' ),
				'id'    => 'mo_newebpay_shipping_hash_key',
				'type'  => 'text',
			],
			[
				'title' => __( '正式 HashIV', 'mo-ectools' ),
				'id'    => 'mo_newebpay_shipping_hash_iv',
				'type'  => 'text',
			],
			[
				'type' => 'sectionend',
			...
			[
				...
				'id'    => 'mo_newebpay_shipping_carriers_section',
			],
			[
				'title'   => __( '允許的超商品牌', 'mo-ectools' ),
				'id'      => 'mo_newebpay_shipping_enabled_carriers',
				'type'    => 'multiselect',
			...
			[
				...
				'type'  => 'title',
				'id'    => 'mo_newebpay_shipping_misc_section',
			],
			[
				'title'   => __( 'Debug 日誌', 'mo-ectools' ),
				'id'      => 'mo_newebpay_shipping_debug_log_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
