	...
	public function get_settings(): array {
		return [
			[
				...
				'id'    => 'mo_ecpay_shipping_section',
			],
			[
				'title'   => __( '啟用測試模式', 'mo-ectools' ),
				'id'      => 'mo_ecpay_shipping_sandbox_enabled',
				'type'    => 'checkbox',
				'default' => 'yes',
			...
			[
				...
				'id'    => 'mo_ecpay_shipping_b2c_section',
			],
			[
				'title'   => __( '測試 MerchantID', 'mo-ectools' ),
				'id'      => 'mo_ecpay_shipping_b2c_sandbox_merchant_id',
				'type'    => 'text',
				'default' => Helper::SANDBOX_B2C_MERCHANT_ID,
			],
			[
				'title'   => __( '測試 HashKey', 'mo-ectools' ),
				'id'      => 'mo_ecpay_shipping_b2c_sandbox_hash_key',
				'type'    => 'text',
				'default' => Helper::SANDBOX_B2C_HASH_KEY,
			],
			[
				'title'   => __( '測試 HashIV', 'mo-ectools' ),
				'id'      => 'mo_ecpay_shipping_b2c_sandbox_hash_iv',
				'type'    => 'text',
				'default' => Helper::SANDBOX_B2C_HASH_IV,
			],
			[
				'title' => __( '正式 MerchantID', 'mo-ectools' ),
				'id'    => 'mo_ecpay_shipping_b2c_merchant_id',
				'type'  => 'text',
			],
			[
				'title' => __( '正式 HashKey', 'mo-ectools' ),
				'id'    => 'mo_ecpay_shipping_b2c_hash_key',
				'type'  => 'text',
			],
			[
				'title' => __( '正式 HashIV', 'mo-ectools' ),
				'id'    => 'mo_ecpay_shipping_b2c_hash_iv',
				'type'  => 'text',
			],
			[
				'type' => 'sectionend',
			...
			[
				...
				'id'    => 'mo_ecpay_shipping_sender_section',
			],
			[
				'title' => __( '姓名', 'mo-ectools' ),
				'id'    => 'mo_ecpay_shipping_sender_name',
				'type'  => 'text',
				'desc'  => __( '中文 1-10 字 / 英文 1-20 字。', 'mo-ectools' ),
			],
			[
				'title' => __( '電話', 'mo-ectools' ),
				'id'    => 'mo_ecpay_shipping_sender_phone',
				'type'  => 'text',
				'desc'  => __( '室內電話。', 'mo-ectools' ),
			],
			[
				'title' => __( '手機', 'mo-ectools' ),
				'id'    => 'mo_ecpay_shipping_sender_cellphone',
				'type'  => 'text',
				'desc'  => __( '宅配 / 黑貓必填。', 'mo-ectools' ),
			],
			[
				'title' => __( 'Email', 'mo-ectools' ),
				'id'    => 'mo_ecpay_shipping_sender_email',
				'type'  => 'email',
			],
			[
				'title' => __( '寄件地址', 'mo-ectools' ),
				'id'    => 'mo_ecpay_shipping_sender_address',
				'type'  => 'textarea',
			...
			[
				...
				'type'  => 'title',
				'id'    => 'mo_ecpay_shipping_misc_section',
			],
			[
				'title'   => __( 'Debug 日誌', 'mo-ectools' ),
				'id'      => 'mo_ecpay_shipping_debug_log_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
