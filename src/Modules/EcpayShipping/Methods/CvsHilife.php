...
final class CvsHilife extends AbstractCvsShippingMethod {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_title       = __( 'ECPay — Hi-Life pickup', 'moksa-for-woocommerce' );
		$this->method_description = __( 'ECPay Hi-Life pickup.', 'moksa-for-woocommerce' );
	...
	public function carrier_label(): string {
		return __( 'Hi-Life', 'moksa-for-woocommerce' );
	}
