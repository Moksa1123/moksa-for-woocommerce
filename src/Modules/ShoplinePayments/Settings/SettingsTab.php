	...
	public function get_settings(): array {
		...
		return [
			[
				...
				'id'    => 'mo_shopline_payments_section',
			],
			[
				'title'   => __( '啟用測試模式', 'mo-ectools' ),
				'id'      => 'mo_shopline_payments_sandbox_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
			...
			[
				...
				'id'    => 'mo_shopline_payments_webhook_section',
			],
			[
				'type' => 'sectionend',
				'id'   => 'mo_shopline_payments_webhook_section',
			...
			[
				...
				'type'  => 'title',
				'id'    => 'mo_shopline_payments_misc_section',
			],
			[
				'title'   => __( '允許的付款方式', 'mo-ectools' ),
				'id'      => 'mo_shopline_payments_payment_methods',
				'type'    => 'multiselect',
			...
			[
				...
				'id'      => 'mo_shopline_payments_debug_log_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
