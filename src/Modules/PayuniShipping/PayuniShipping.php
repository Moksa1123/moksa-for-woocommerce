...
class PayuniShipping {
	...
	public static function register_batch_print( array $providers ): array {
		$cvs_titles = [
			...
			'moksafowo_payuni_shipping_711_c2c_normal' => __( 'PAYUNi 7-ELEVEN store-to-store ambient', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_711_c2c_frozen' => __( 'PAYUNi 7-ELEVEN store-to-store frozen', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_711_b2c_normal' => __( 'PAYUNi 7-ELEVEN bulk ambient', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_711_b2c_frozen' => __( 'PAYUNi 7-ELEVEN bulk frozen', 'moksa-for-woocommerce' ),
		];
		$hd_titles  = [
			'moksafowo_payuni_shipping_tcat'              => __( 'PAYUNi T-Cat home delivery', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_tcat_normal'       => __( 'PAYUNi T-Cat ambient', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_tcat_frozen'       => __( 'PAYUNi T-Cat frozen', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_tcat_refrigerated' => __( 'PAYUNi T-Cat chilled', 'moksa-for-woocommerce' ),
		];
		...
		if ( ! empty( $hd ) ) {
			$providers['moksafowo-payuni-home'] = [
				'label'          => __( 'PAYUNi home delivery labels', 'moksa-for-woocommerce' ),
				'category'       => 'home',
				'method_ids'     => $hd,
