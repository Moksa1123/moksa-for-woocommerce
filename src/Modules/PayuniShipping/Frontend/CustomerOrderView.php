...
final class CustomerOrderView {
			...
			<div class="moksafowo-shipping-card__body">
				...
				if ( $is_cvs ) {
					...
					if ( '' !== $recipient ) :
						?>
						<div class="moksafowo-shipping-card__row">
							<span class="moksafowo-shipping-card__label"><?php esc_html_e( 'Recipient', 'moksa-for-woocommerce' ); ?></span>
					...
					if ( '' !== $address ) :
						?>
						<div class="moksafowo-shipping-card__row">
							<span class="moksafowo-shipping-card__label"><?php esc_html_e( 'Delivery address', 'moksa-for-woocommerce' ); ?></span>
				...
				if ( $is_split ) :
					...
					<div class="moksafowo-shipping-card__row" style="grid-template-columns:1fr;border-bottom:1px dashed #f1f5f9;">
						<span class="moksafowo-shipping-card__label" style="font-size:12px;">
							...
							echo esc_html( sprintf( __( 'This order is split into %d shipments by temperature zone', 'moksa-for-woocommerce' ), count( $records ) ) );
							?>
						</span>
					</div>
					<?php
				...
				foreach ( $records as $r ) :
					...
					<div class="moksafowo-shipping-card__row">
						<span class="moksafowo-shipping-card__label">
							<?php
							echo esc_html__( 'Shipping ID', 'moksa-for-woocommerce' );
						...
						<span class="moksafowo-shipping-card__value" style="display:flex;flex-direction:column;gap:6px;">
							...
							<?php if ( '' !== $odno && $odno !== $ship_trade_no ) : ?>
								<span style="font-size:12px;color:#475569;">
									<?php esc_html_e( 'Carrier shipment number:', 'moksa-for-woocommerce' ); ?>
	...
	private static function carrier_title( string $method_id ): string {
		$map = [
			'moksafowo_payuni_shipping_tcat'              => __( 'PAYUNi — T-Cat home delivery', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_tcat_normal'       => __( 'PAYUNi — T-Cat home delivery (ambient)', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_tcat_refrigerated' => __( 'PAYUNi — T-Cat home delivery (chilled)', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_tcat_frozen'       => __( 'PAYUNi — T-Cat home delivery (frozen)', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_711_c2c'           => __( 'PAYUNi — 7-ELEVEN C2C pickup', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_711_b2c'           => __( 'PAYUNi — 7-ELEVEN B2C pickup', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_711_c2c_normal'    => __( 'PAYUNi — 7-ELEVEN C2C ambient', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_711_c2c_frozen'    => __( 'PAYUNi — 7-ELEVEN C2C frozen', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_711_b2c_normal'    => __( 'PAYUNi — 7-ELEVEN B2C ambient', 'moksa-for-woocommerce' ),
			'moksafowo_payuni_shipping_711_b2c_frozen'    => __( 'PAYUNi — 7-ELEVEN B2C frozen', 'moksa-for-woocommerce' ),
		];
		return $map[ $method_id ] ?? __( 'PAYUNi shipping', 'moksa-for-woocommerce' );
	}
