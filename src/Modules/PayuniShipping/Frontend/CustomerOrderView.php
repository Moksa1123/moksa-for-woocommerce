...
final class CustomerOrderView {
	...
	public static function render( $order ): void {
		...
		$is_cvs      = PayuniShipping::is_mo_payuni_shipping_cvs( $method_id );
					...
					<div class="mo-shipping-card__row">
						...
						<span class="mo-shipping-card__value" style="display:flex;flex-direction:column;gap:6px;">
							<?php if ( '' !== $ship_trade_no ) : ?>
								<span class="mo-shipping-card__code"><?php echo esc_html( $ship_trade_no ); ?></span>
							<?php endif; ?>
							<?php if ( '' !== $odno && $odno !== $ship_trade_no ) : ?>
								<span style="font-size:12px;color:#475569;">
									<?php esc_html_e( '物流商出貨編號：', 'mo-ectools' ); ?>
									<span class="mo-shipping-card__code"><?php echo esc_html( $odno ); ?></span>
								</span>
							<?php endif; ?>
	...
	private static function carrier_title( string $method_id ): string {
		$map = [
			...
			'mo_payuni_shipping_tcat_normal'  => __( 'PAYUNi — 黑貓宅配 (常溫)', 'mo-ectools' ),
			'mo_payuni_shipping_tcat_refrigerated' => __( 'PAYUNi — 黑貓宅配 (冷藏)', 'mo-ectools' ),
			'mo_payuni_shipping_tcat_frozen'  => __( 'PAYUNi — 黑貓宅配 (冷凍)', 'mo-ectools' ),
			'mo_payuni_shipping_711_c2c'      => __( 'PAYUNi — 7-11 C2C 取貨', 'mo-ectools' ),
			'mo_payuni_shipping_711_b2c'      => __( 'PAYUNi — 7-11 B2C 取貨', 'mo-ectools' ),
			'mo_payuni_shipping_711_c2c_normal' => __( 'PAYUNi — 7-11 C2C 常溫', 'mo-ectools' ),
			'mo_payuni_shipping_711_c2c_frozen' => __( 'PAYUNi — 7-11 C2C 冷凍', 'mo-ectools' ),
			'mo_payuni_shipping_711_b2c_normal' => __( 'PAYUNi — 7-11 B2C 常溫', 'mo-ectools' ),
			'mo_payuni_shipping_711_b2c_frozen' => __( 'PAYUNi — 7-11 B2C 冷凍', 'mo-ectools' ),
		];
