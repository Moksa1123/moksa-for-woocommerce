...
class HDRefrigerated extends ShippingBase {

	use TCatHDTrait;

	public const ID = 'moksafowo_payuni_shipping_tcat_refrigerated';
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = self::ID;
		$this->method_title       = __( 'PAYUNi — T-Cat home delivery (chilled)', 'moksa-for-woocommerce' );
		$this->method_description = __( 'PAYUNi — T-Cat home delivery (chilled)', 'moksa-for-woocommerce' );
