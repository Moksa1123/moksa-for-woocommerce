...
class HDNormal extends ShippingBase {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = self::ID;
		$this->method_title       = __( 'PAYUNi — T-Cat home delivery (ambient)', 'moksa-for-woocommerce' );
		$this->method_description = __( 'PAYUNi — T-Cat home delivery (ambient)', 'moksa-for-woocommerce' );
