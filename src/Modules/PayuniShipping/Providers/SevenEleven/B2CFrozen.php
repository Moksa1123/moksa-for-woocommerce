...
class B2CFrozen extends ShippingBase {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = self::ID;
		$this->method_title       = __( 'PAYUNi — 7-ELEVEN bulk store pickup (frozen)', 'moksa-for-woocommerce' );
		$this->method_description = __( 'PAYUNi — 7-ELEVEN bulk store pickup (frozen)', 'moksa-for-woocommerce' );
