...
final class C2CUnified extends AbstractCvsShippingMethod {
	...
	public function __construct( $instance_id = 0 ) {
		$this->id                 = self::ID;
		$this->method_title       = __( 'PAYUNi — 7-ELEVEN store pickup (mixed temperature zones)', 'moksa-for-woocommerce' );
		$this->method_description = __( 'PAYUNi 7-ELEVEN store pickup, for ambient and frozen goods. 7-ELEVEN does not offer chilled delivery, so chilled products travel at ambient temperature.', 'moksa-for-woocommerce' );
