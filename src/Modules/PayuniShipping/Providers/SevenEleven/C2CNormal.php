...
class C2CNormal extends ShippingBase {

	use CVSTrait;

	public const ID = 'moksafowo_payuni_shipping_711_c2c_normal';
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = self::ID;
		$this->method_title       = __( 'PAYUNi — 7-ELEVEN store pickup (ambient)', 'moksa-for-woocommerce' );
		$this->method_description = __( 'PAYUNi — 7-ELEVEN store pickup (ambient)', 'moksa-for-woocommerce' );
	...
	public function init() {
		...
		$this->instance_form_fields = include MOKSAFOWO_PLUGIN_DIR . 'src/Modules/PayuniShipping/Settings/SevenEleven/C2CNormalFields.php';
