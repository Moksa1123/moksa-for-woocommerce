...
class C2CNormal extends ShippingBase {
	...
	public const ID = 'mo_payuni_shipping_711_c2c_normal';
	...
	public function init() {
		...
		$this->instance_form_fields = include MOWC_PLUGIN_DIR . 'src/Modules/PayuniShipping/Settings/SevenEleven/C2CNormalFields.php';
