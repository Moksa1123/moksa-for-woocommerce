...
final class AdminActions extends AbstractAdminActions {
	...
	public function get_bulk_action_labels(): array {
		return [
			'print_711'  => __( 'Bulk print convenience store pickup labels', 'moksa-for-woocommerce' ),
			'print_tcat' => __( 'Bulk print T-Cat home delivery labels', 'moksa-for-woocommerce' ),
		];
	}
