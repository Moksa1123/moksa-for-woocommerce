...
final class AdminActions extends AbstractAdminActions {
	...
	public function meta_key_trade_no(): string { return '_moksafowo_payuni_shipping_trade_no'; }
	public function meta_key_ship_no(): string { return '_moksafowo_payuni_shipping_ship_no'; }
	...
	public function handle_bulk_action( string $action, array $order_ids ): string {
		...
		// 組 print URL — 用既有 moksafowo_payuni_shipping_print_label endpoint
