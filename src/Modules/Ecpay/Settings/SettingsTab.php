	...
	public function get_settings(): array {
		return [
			...
			[
				...
				'css'     => 'width: 400px;',
				'options' => [
					'moksafowo_ecpay_credit'    => __( '信用卡（一次付清）', 'mo-ectools' ),
					'moksafowo_ecpay_credit_3'  => __( '信用卡分期 3 期', 'mo-ectools' ),
					'moksafowo_ecpay_credit_6'  => __( '信用卡分期 6 期', 'mo-ectools' ),
					'moksafowo_ecpay_credit_12' => __( '信用卡分期 12 期', 'mo-ectools' ),
					'moksafowo_ecpay_credit_18' => __( '信用卡分期 18 期', 'mo-ectools' ),
					'moksafowo_ecpay_credit_24' => __( '信用卡分期 24 期', 'mo-ectools' ),
					'moksafowo_ecpay_atm'       => __( 'ATM 虛擬帳號', 'mo-ectools' ),
					'moksafowo_ecpay_cvs'       => __( '超商代碼', 'mo-ectools' ),
					'moksafowo_ecpay_barcode'   => __( '超商條碼', 'mo-ectools' ),
					'moksafowo_ecpay_webatm'    => __( '網路 ATM', 'mo-ectools' ),
					'moksafowo_ecpay_applepay'  => __( 'Apple Pay', 'mo-ectools' ),
					'moksafowo_ecpay_twqr'      => __( '行動支付（TWQR Pay）', 'mo-ectools' ),
					'moksafowo_ecpay_bnpl'      => __( '無卡分期', 'mo-ectools' ),
					'moksafowo_ecpay_weixin'    => __( '微信支付', 'mo-ectools' ),
