...
namespace MoksaWeb\Mowc\Modules\Linepay\Settings;
...
class SettingsTab extends WC_Settings_Page {
	...
	public function get_settings( $current_section = '' ) {
		...
		$settings = apply_filters(
			...
			'Mo_LinePay_payment_settings',
			array(
				array(
					'title' => __( '一般', 'mo-ectools' ),
					'type'  => 'title',
					'id'    => 'Mo_LinePay_general_setting',
				),
				array(
					...
					'id'      => 'Mo_LinePay_debug_log_enabled',
				),
				array(
					...
					'id'      => 'Mo_LinePay_display_logo_enabled',
				),
				array(
					...
					'default' => 'wc-failed',
					'id'      => 'Mo_LinePay_payment_fail_order_status',
				),
				array(
					...
					'id'      => 'Mo_LinePay_detail_status_note_enabled',
				),
				array(
					'type' => 'sectionend',
					'id'   => 'Mo_LinePay_general_setting',
				...
				array(
					...
					'id'      => 'Mo_LinePay_sandboxmode_enabled',
				),
				array(
					'title'   => __( '測試 Channel ID', 'mo-ectools' ),
					'type'    => 'text',
					'default' => '',
					'id'      => 'Mo_LinePay_sandbox_channel_id',
				),
				array(
					'title'   => __( '測試 Channel Secret', 'mo-ectools' ),
					'type'    => 'text',
					'default' => '',
					'id'      => 'Mo_LinePay_sandbox_channel_secret',
				),
				array(
					'title'   => __( '正式 Channel ID', 'mo-ectools' ),
					'type'    => 'text',
					'default' => '',
					'id'      => 'Mo_LinePay_channel_id',
				),
				array(
					'title'   => __( '正式 Channel Secret', 'mo-ectools' ),
					'type'    => 'text',
					'default' => '',
					'id'      => 'Mo_LinePay_channel_secret',
				),
				array(
					'type' => 'sectionend',
					'id'   => 'Mo_LinePay_api_settings',
