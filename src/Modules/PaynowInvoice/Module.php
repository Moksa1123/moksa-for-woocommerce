...
final class Module extends AbstractModule {
	...
	public function label(): string {
		return __( 'PayNow e-invoice — B2C and B2B, mobile barcode, Citizen Digital Certificate and donation', 'moksa-for-woocommerce' );
	}
	...
	public function name(): string {
		return __( 'PayNow e-invoice', 'moksa-for-woocommerce' );
	}

	public function tagline(): string {
		return __( 'B2C, B2B, carriers and donations — part of PayNow', 'moksa-for-woocommerce' );
	}
