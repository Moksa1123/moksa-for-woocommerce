...
final class CustomerOrderView {
	...
	private static function carrier_title( string $method_id ): string {
		$map = [
			...
			'moksafowo_smilepay_shipping_tcat_normal'  => __( 'SmilePay — T-Cat home delivery (ambient)', 'moksa-for-woocommerce' ),
			'moksafowo_smilepay_shipping_tcat_refrige' => __( 'SmilePay — T-Cat home delivery (chilled)', 'moksa-for-woocommerce' ),
			'moksafowo_smilepay_shipping_tcat_freeze'  => __( 'SmilePay — T-Cat home delivery (frozen)', 'moksa-for-woocommerce' ),
		];
		return $map[ $method_id ] ?? __( 'SmilePay shipping', 'moksa-for-woocommerce' );
	}
