...
class CreditInstallment30 extends GatewayBase {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi credit card, 30 instalments', 'moksa-for-woocommerce' );
		$this->method_description = __( 'Pay by credit card over 30 instalments. The customer is redirected to the PAYUNi payment page.', 'moksa-for-woocommerce' );
