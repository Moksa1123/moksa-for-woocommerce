...
class CreditUnionPay extends GatewayBase {
	...
	const GATEWAY_ID = 'mo_payuni_unionpay';
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi UnionPay', 'mo-ectools' );
		$this->method_description = __( 'PAYUNi UnionPay', 'mo-ectools' );
		$this->supports           = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		$this->form_fields = include MOWC_PLUGIN_DIR . 'src/Modules/Payuni/Settings/CreditUnionPay.php';
	}
