...
class CreditUnionPay extends GatewayBase {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi UnionPay', 'moksa-for-woocommerce' );
		$this->method_description = __( 'Pay across borders with UnionPay. The customer is redirected to the PAYUNi payment page.', 'moksa-for-woocommerce' );
		$this->supports           = array(
			'products',
			'refunds',
		);
