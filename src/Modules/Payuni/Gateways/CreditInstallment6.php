...
class CreditInstallment6 extends GatewayBase {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi credit card, 6 instalments', 'moksa-for-woocommerce' );
		$this->method_description = __( 'Pay by credit card over 6 instalments. The customer is redirected to the PAYUNi payment page.', 'moksa-for-woocommerce' );

		$this->init_installment( 6, $this->min_amount );
