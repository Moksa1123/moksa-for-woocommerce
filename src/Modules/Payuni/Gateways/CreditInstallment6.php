...
class CreditInstallment6 extends GatewayBase {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi Installment Payment (6 Installments)', 'mo-ectools' );
		$this->method_description = __( 'PAYUNi Installment Payment (6 Installments)', 'mo-ectools' );
