...
class JKoPay extends GatewayBase {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi JKOPAY', 'moksa-for-woocommerce' );
		$this->method_description = __( 'Pay with JKOPAY. The customer is redirected to the PAYUNi payment page.', 'moksa-for-woocommerce' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled'     => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable PAYUNi JKOPAY', 'moksa-for-woocommerce' ),
				'default' => 'no',
			),
			'title'       => array(
				'title'   => __( 'Title', 'moksa-for-woocommerce' ),
				'type'    => 'text',
				'default' => __( 'JKOPAY', 'moksa-for-woocommerce' ),
			),
			'description' => array(
