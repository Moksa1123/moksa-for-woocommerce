...
class CreditInstallment18 extends GatewayBase {
	...
	const GATEWAY_ID = 'moksafowo_payuni_installment_18';
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi credit card, 18 instalments', 'moksa-for-woocommerce' );
		$this->method_description = __( 'Pay by credit card over 18 instalments. The customer is redirected to the PAYUNi payment page.', 'moksa-for-woocommerce' );
