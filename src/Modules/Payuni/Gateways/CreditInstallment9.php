...
class CreditInstallment9 extends GatewayBase {
	...
	const GATEWAY_ID = 'mo_payuni_installment_9';
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi Installment Payment (9 Installments)', 'mo-ectools' );
		$this->method_description = __( 'PAYUNi Installment Payment (9 Installments)', 'mo-ectools' );
