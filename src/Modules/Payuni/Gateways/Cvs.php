...
class Cvs extends GatewayBase {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi convenience store code', 'moksa-for-woocommerce' );
		$this->method_description = __( 'Pay with the code at any 7-ELEVEN, FamilyMart, Hi-Life or OK Mart store.', 'moksa-for-woocommerce' );
	...
	public static function get_payment_order_metas() {
		$order_metas =
		array(
			OrderMeta::CVS_PAY_NO      => __( 'Payment code', 'moksa-for-woocommerce' ),
			OrderMeta::CVS_STORE       => __( 'Convenience store', 'moksa-for-woocommerce' ),
			OrderMeta::CVS_EXPIRE_DATE => __( 'Pay before', 'moksa-for-woocommerce' ),
		);
