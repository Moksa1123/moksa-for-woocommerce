	...
	public function get_settings(): array {
		return [
			[
				...
				'id'    => 'mo_tappay_section',
			],
			[
				'title'   => __( '啟用測試模式', 'mo-ectools' ),
				'id'      => 'mo_tappay_sandbox_enabled',
				'type'    => 'checkbox',
				'default' => 'yes',
			...
			[
				...
				'type'  => 'title',
				'id'    => 'mo_tappay_misc_section',
			],
			[
				'title'   => __( '啟用 3D 驗證（3DS）', 'mo-ectools' ),
				'id'      => 'mo_tappay_3ds_enabled',
				'type'    => 'checkbox',
				'default' => 'yes',
			...
			[
				...
				'id'      => 'mo_tappay_debug_log_enabled',
				'type'    => 'checkbox',
				'default' => 'no',
