...
final class Module extends AbstractModule {
	...
	public function label(): string {
		return __( 'ezPay e-invoice — B2C and B2B, mobile barcode, Citizen Digital Certificate, member carrier and donation', 'moksa-for-woocommerce' );
	}
	...
	public function name(): string {
		return __( 'ezPay e-invoice', 'moksa-for-woocommerce' );
	}

	public function tagline(): string {
		return __( 'B2C, B2B, carriers and donations — part of NewebPay', 'moksa-for-woocommerce' );
	}
	...
	public function methods(): array {
		return [
			...
			__( 'ezPay member carrier', 'moksa-for-woocommerce' ),
