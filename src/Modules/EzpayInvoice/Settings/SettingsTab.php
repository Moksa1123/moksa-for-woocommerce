	...
	public function get_settings(): array {
		return [
			[
				...
				'type'  => 'title',
				'desc'  => __( 'ezPay 電子發票串接。請先至 ezPay 後台申請會員、開立商店，取得商店憑證後填入下方。', 'moksa-for-woocommerce' ),
			...
			[
				...
				'type'    => 'checkbox',
				'default' => 'no',
				'desc'    => __( '勾選後走測試環境，不會真正開立發票。上線後請取消勾選。', 'moksa-for-woocommerce' ),
			],
			[
				...
				'type'              => 'text',
				'default'           => '',
				'desc'              => __( '送至 ezPay 的訂單編號前綴（限英數，最多 5 字元）。留空即無前綴。', 'moksa-for-woocommerce' ),
				'desc_tip'          => true,
				'custom_attributes' => [
			...
			[
				...
				'desc'          => __( 'ezPay 平台會員載具', 'moksa-for-woocommerce' ),
			...
			[
				...
				'type'     => 'select',
				'options'  => [
					'member' => __( 'ezPay 平台會員載具', 'moksa-for-woocommerce' ),
			...
			[
				...
				'desc'  => sprintf(
					...
					__( '從 %s 申請取得。ezPay 沒有公開共用測試帳號，每個商家自家測試環境憑證不同。', 'moksa-for-woocommerce' ),
			...
			[
				...
				'type'  => 'title',
				'desc'  => __( '從 inv.ezpay.com.tw 申請取得。需 ezPay 審核啟用後才能用。', 'moksa-for-woocommerce' ),
