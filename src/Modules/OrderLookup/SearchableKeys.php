...
final class SearchableKeys {
	...
	public static function field_labels(): array {
		return [
			'invoice'  => __( '發票號碼', 'mo-ectools' ),
			'shipping' => __( '物流單號', 'mo-ectools' ),
			'payment'  => __( '金流交易序號', 'mo-ectools' ),
			'ubn'      => __( '統一編號', 'mo-ectools' ),
			'atm'      => __( 'ATM 虛擬帳號', 'mo-ectools' ),
			'cvs'      => __( '超商繳費代碼', 'mo-ectools' ),
			'card'     => __( '卡末四碼', 'mo-ectools' ),
			'tcat'     => __( '黑貓追蹤號', 'mo-ectools' ),
		];
	}
