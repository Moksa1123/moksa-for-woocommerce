...
final class SearchableKeys {
	...
	private static function groups(): array {
		return [
			[
				'field' => 'payment',
				'label' => __( 'Payment transaction ID', 'moksa-for-woocommerce' ),
				'slug'  => 'ecpay',
			...
			[
				'field' => 'shipping',
				'label' => __( 'Tracking number', 'moksa-for-woocommerce' ),
				'slug'  => 'ecpay_shipping',
			...
			[
				'field' => 'atm',
				'label' => __( 'ATM virtual account', 'moksa-for-woocommerce' ),
				'slug'  => 'ecpay',
			...
			[
				'field' => 'card',
				'label' => __( 'Last four card digits', 'moksa-for-woocommerce' ),
				'slug'  => 'ecpay',
			...
			[
				'field' => 'tcat',
				'label' => __( 'T-Cat tracking number', 'moksa-for-woocommerce' ),
				'slug'  => 'smilepay_shipping',
	...
	public static function field_labels(): array {
		return [
			'invoice'  => __( 'Invoice number', 'moksa-for-woocommerce' ),
			'shipping' => __( 'Tracking number', 'moksa-for-woocommerce' ),
			'payment'  => __( 'Payment transaction ID', 'moksa-for-woocommerce' ),
			'ubn'      => __( 'Tax ID', 'moksa-for-woocommerce' ),
			'atm'      => __( 'ATM virtual account', 'moksa-for-woocommerce' ),
			'cvs'      => __( 'Convenience store payment code', 'moksa-for-woocommerce' ),
			'card'     => __( 'Last four card digits', 'moksa-for-woocommerce' ),
			'tcat'     => __( 'T-Cat tracking number', 'moksa-for-woocommerce' ),
		];
	}
