	...
	public function get_settings(): array {
		return [
			[
				...
				'type'  => 'title',
				'desc'  => __( 'SmilePay 電子發票串接。請先至 SmilePay 申請會員、開立商店，取得商店憑證後填入下方。', 'moksa-for-woocommerce' ),
			...
			[
				...
				'type'    => 'checkbox',
				'default' => 'no',
				'desc'    => __( '勾選後走 SmilePay 測試環境，不會真正開立。SmilePay 沒有公開測試帳號，須向業務窗口申請測試憑證後才能使用。', 'moksa-for-woocommerce' ),
			],
			[
				...
				'type'              => 'text',
				'default'           => '',
				'desc'              => __( '送至 SmilePay 的訂單編號前綴（限英數，最多 5 字元）。留空即無前綴。', 'moksa-for-woocommerce' ),
				'desc_tip'          => true,
				'custom_attributes' => [
			...
			[
				'title'    => __( '字軌系統碼', 'moksa-for-woocommerce' ),
				'id'       => 'moksafowo_smilepay_invoice_track_system_id',
				'type'     => 'text',
				'desc'     => __( '從 SmilePay 後台字軌管理頁取得。有多本字軌時用來指定使用哪一本。', 'moksa-for-woocommerce' ),
				'desc_tip' => true,
			],
			[
				...
				'options' => [
					...
					'manual'    => __( '手動 — 商家自己在訂單頁按「開立發票」按鈕', 'moksa-for-woocommerce' ),
				],
			],
			[
			...
			[
				...
				'desc'          => __( 'SmilePay 會員載具', 'moksa-for-woocommerce' ),
			...
			[
				'title' => __( '測試環境憑證', 'moksa-for-woocommerce' ),
				'type'  => 'title',
				'desc'  => __( 'SmilePay 沒有公開測試帳號，需自行向業務窗口申請測試串接。', 'moksa-for-woocommerce' ),
				'id'    => 'moksafowo_smilepay_invoice_sandbox_section',
			],
			[
				'title' => __( '測試 Grvc', 'moksa-for-woocommerce' ),
				'id'    => 'moksafowo_smilepay_invoice_sandbox_grvc',
				'type'  => 'text',
				'desc'  => __( '商家串接代號。', 'moksa-for-woocommerce' ),
			],
			[
				'title' => __( '測試 Verify_key', 'moksa-for-woocommerce' ),
				'id'    => 'moksafowo_smilepay_invoice_sandbox_verify_key',
				'type'  => 'text',
				'desc'  => __( '驗證碼。', 'moksa-for-woocommerce' ),
			],
			[
				'type' => 'sectionend',
				'id'   => 'moksafowo_smilepay_invoice_sandbox_section',
			...
			[
				'title' => __( '正式 Grvc', 'moksa-for-woocommerce' ),
				'id'    => 'moksafowo_smilepay_invoice_grvc',
				'type'  => 'text',
			],
			[
				'title' => __( '正式 Verify_key', 'moksa-for-woocommerce' ),
