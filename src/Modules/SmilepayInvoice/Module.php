...
final class Module extends AbstractModule {
	...
	public function label(): string {
		return __( 'SmilePay e-invoice — member carrier, mobile barcode, Citizen Digital Certificate, tax ID and donation', 'moksa-for-woocommerce' );
	}
	...
	public function name(): string {
		return __( 'SmilePay e-invoice', 'moksa-for-woocommerce' );
	}

	public function tagline(): string {
		return __( 'B2C, B2B, carriers and donations — part of SmilePay', 'moksa-for-woocommerce' );
	}
	...
	public function methods(): array {
		return [
			...
			__( 'SmilePay member carrier', 'moksa-for-woocommerce' ),
